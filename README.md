...
3. If the "myserverlessapp" is not visible under direct messages, click the tab to be able to open up a conversation with it directly.
...
This clock functionality was created using Google APIs in order to find the location of the address (lat, long from Geocoding API) and timezone of said location (timezoneID from Timezone API). This information was then, in turn, used to find out a string of the
